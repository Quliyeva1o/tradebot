#!/usr/bin/env python3
"""Crash-visibility supervisor for run_live_xauusd_orb.py.
...
Usage (mirrors run_live_xauusd_orb.py's own CLI exactly -- all args are
forwarded unchanged to the child process):
    python run_live_xauusd_orb_with_crash_alert.py --symbol XAUUSD --timeframe M15
"""
...
TARGET_SCRIPT = ROOT_DIR / "run_live_xauusd_orb.py"
CRASH_LOG = ROOT_DIR / "logs" / "run_live_xauusd_orb_crashes.log"
