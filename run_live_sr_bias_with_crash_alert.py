#!/usr/bin/env python3
"""Crash-visibility supervisor for run_live_sr_bias.py.
...
Usage (mirrors run_live_sr_bias.py's own CLI exactly -- all args are
forwarded unchanged to the child process):
    python run_live_sr_bias_with_crash_alert.py --symbol NAS100 --timeframe M15
"""
...
TARGET_SCRIPT = ROOT_DIR / "run_live_sr_bias.py"
CRASH_LOG = ROOT_DIR / "logs" / "run_live_sr_bias_crashes.log"
