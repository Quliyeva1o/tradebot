"""Runs scripts.po3_backtest across every symbol/TF combo, mirrors
scripts/order_flow_bias_sweep.py.
"""
...
from scripts.po3_backtest import run_backtest, write_trades_csv
...
def main() -> None:
    ...
    for symbol in SYMBOLS:
        for tf in TFS:
            ...
            write_trades_csv(trades, f"artifacts/po3_trades_{symbol}_{tf}m.csv")
            s = stats(trades)
            dt = time.time() - t0
