...
from market_structure.swing_models import SwingConfig, SwingClassification
...
def run_manual_test():
    ...
    for swing in swings:
        ...
        print(f"Index: {swing.index:02d} | Time: {swing.timestamp} | Type: {swing.type.name:<4} | Price: {swing.price:.5f} | Class: {classification}")
