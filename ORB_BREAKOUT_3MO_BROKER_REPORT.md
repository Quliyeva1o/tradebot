...
Hazırlandı: 2026-09-20 19:53 UTC · pəncərə: **2026-06-21 → 2026-09-18** (90 gün) · hər bot ayrıca $50,000 hesabda · skript: `scripts/orb_breakout_year_backtest.py`
...
|---|---|---|---|---|---|---|
| OrbBreakout_DJI30_Demo | DJI30 | Demo (rev 0.5R) | 60m OR / M1 / 4R | 13 / 0.831 / -1.2R / -$329 | 13 / 0.875 / -0.9R / -$303 | +0.3R |
...
| OrbBreakout_JP225_Demo | JP225 | Demo (rev 0.5R) | 15m OR / M1 / 4R | 83 / 0.760 / -12.8R / -$1,389 | 84 / 0.662 / -19.0R / -$4,606 | -6.1R |
...
| OrbBreakout_NDX100_Demo | NDX100 | Demo (rev 0.5R) | 30m OR / M5 / 4R | 32 / 0.710 / -5.9R / -$1,497 | 32 / 0.718 / -5.7R / -$1,402 | +0.2R |
...
| OrbBreakout_SPX500_Demo | SPX500 | Demo (rev 0.5R) | 60m OR / M1 / 4R | 15 / 0.399 / -7.7R / -$1,891 | 13 / 0.586 / -4.0R / -$932 | +3.7R |
...
| OrbBreakout_XAUUSD_Demo | XAUUSD | Demo (rev 0.5R) | 15m OR / M1 / 4R | 78 / 0.722 / -14.5R / -$2,998 | 78 / 0.784 / -10.6R / -$2,108 | +3.9R |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| OrbBreakout_DJI30_Demo | 13 | 53.8% | 0.831 | -1.2 | 4.8 | 7 | 6 | $49,671 | 2.3% | -0.7% | -$531 | $0 | 0 |
...
| OrbBreakout_JP225_Demo | 83 | 39.8% | 0.760 | -12.8 | 19.4 | 33 | 50 | $48,611 | 6.2% | -2.8% | -$141 | $0 | 0 |
...
| OrbBreakout_NDX100_Demo | 32 | 46.9% | 0.710 | -5.9 | 6.6 | 15 | 17 | $48,503 | 3.3% | -3.0% | -$352 | $0 | 1 |
...
| OrbBreakout_SPX500_Demo | 15 | 26.7% | 0.399 | -7.7 | 8.1 | 4 | 11 | $48,109 | 4.1% | -3.8% | -$483 | $0 | 1 |
...
| OrbBreakout_XAUUSD_Demo | 78 | 35.9% | 0.722 | -14.5 | 24.1 | 28 | 50 | $47,002 | 11.0% | -6.0% | -$197 | -$58 | 1 |
...
| Bot | n | qazanc % | PF | netR | maxDD R | TP | SL | son balans | maxDD % | gəlir % | swap $ | komissiya $ | açıq |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| OrbBreakout_DJI30_Demo | 13 | 53.8% | 0.875 | -0.9 | 4.6 | 7 | 6 | $49,697 | 2.2% | -0.6% | -$421 | $0 | 0 |
...
| OrbBreakout_JP225_Demo | 84 | 38.1% | 0.662 | -19.0 | 23.1 | 32 | 52 | $45,394 | 10.9% | -9.2% | -$282 | $0 | 0 |
...
| OrbBreakout_NDX100_Demo | 32 | 46.9% | 0.718 | -5.7 | 6.6 | 15 | 17 | $48,598 | 3.2% | -2.8% | -$302 | $0 | 1 |
...
| OrbBreakout_SPX500_Demo | 13 | 38.5% | 0.586 | -4.0 | 5.0 | 5 | 8 | $49,068 | 2.4% | -1.9% | -$410 | $0 | 1 |
...
| OrbBreakout_XAUUSD_Demo | 78 | 37.2% | 0.784 | -10.6 | 20.6 | 29 | 49 | $47,892 | 9.5% | -4.2% | -$166 | $0 | 1 |
...
- **Lot tavanı.** Aşağıdakı botlar trade-lərinin bir hissəsində brokerin `volume_max` həddinə dirənir, yəni nəzərdə tutulan 0.5% riski ala bilmir — orada dollar sütunu zərəri olduğundan kiçik göstərir, **R sütunu isə düzgündür**:
  - `OrbBreakout_JP225_Demo` @ fundingpips: trade-lərin 66%-i 10 lot tavanında, median risk $215 (hədəf ~$250)
...
- **Nümunə kiçikdir.** Bu pəncərədə bot başına 7–84 bağlanmış trade var. Bu qədər trade-də PF-in təsadüfi sürüşməsi böyük olur — pəncərə nə qədər qısadırsa, nəticəni bir o qədər az ciddiyə almaq lazımdır.
