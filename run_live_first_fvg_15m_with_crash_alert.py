#!/usr/bin/env python3
"""Crash-visibility supervisor for run_live_first_fvg_15m.py.
...
Usage (mirrors run_live_first_fvg_15m.py's own CLI exactly -- all args are
forwarded unchanged to the child process):
    python run_live_first_fvg_15m_with_crash_alert.py --symbol NAS100
"""
...
TARGET_SCRIPT = ROOT_DIR / "run_live_first_fvg_15m.py"
CRASH_LOG = ROOT_DIR / "logs" / "run_live_first_fvg_15m_crashes.log"
